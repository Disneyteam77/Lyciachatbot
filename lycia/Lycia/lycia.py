...
async def lycia(client, message):
    ...
    if chat_id in en_chats:
        ...
        result = result.replace("Aco", "Erza ")
        result = result.replace("Eliza", "@ErzaChat_bot")
        result = result.replace("Hi~", "Hello Friend I Am @ErzaChat_bot")
        result = result.replace("My dear great botmaster, Yᴇᴀɢᴇʀɪsᴛ Bᴏᴛs .", "Made By @Yeageristbotsdev")
        result = result.replace("Have the control right.", "My Father Is @Yeageristbotsdev")
        result = result.replace("I was created by Yᴇᴀɢᴇʀɪsᴛ Bᴏᴛs .", "I was created by @Yeageristbotsdev Team.")
